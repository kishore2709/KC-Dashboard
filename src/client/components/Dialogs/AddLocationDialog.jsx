...
import { locationTableActions, dialogActions } from '_actions';
...
class FormDialog extends React.Component {
  ...
  handleClose = () => {
    ...
    // this.props.onClose();
    this.props.closeDialog({ type: 'addLocationDialog', message: { open: false } });
  };
  ...
  render() {
    const { classes, addLocationDialog } = this.props;

    return (
      <div>
        <Dialog
          fullWidth
          open={addLocationDialog.open}
              ...
              <GridItem xs={12} sm={12} md={12}>
                <Card>
                  <CardHeader color="danger">
                    <h4 className={classes.cardTitleWhite}>Thêm vị trí</h4>
...
export default withStyles(styles)(
  connect(
    state => ({ addLocationDialog: state.addLocationDialog }),
    mapDispatchToProps
